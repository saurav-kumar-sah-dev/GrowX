...
import { Brain, Trophy, Zap, Play, Target, Users, BookOpen, Sparkles, ChevronDown, Award, TrendingUp, Clock, Star, Code, Lightbulb, GraduationCap, Globe, Rocket } from "lucide-react";
        ...
        >
          ...
          >
            <motion.div variants={fadeIn} custom={0.1}>
              <SectionLabel>Challenge Your Mind</SectionLabel>
            </motion.div>
            ...
            >
              <span className="block mb-2">Test Your</span>
              <span 
                className="block"
                style={{
              ...
              >
                <AnimatedText text="Knowledge!" delay={0.3} />
              </span>
            </motion.h1>
            ...
            >
              ...
              compete with friends, and master new skills. Join <span style={{ color: T.gold, fontWeight: 600 }}>10,000+</span> quiz enthusiasts.
            </motion.p>
            ...
            <motion.div variants={fadeIn} custom={0.5} className="flex flex-wrap gap-4 pt-2">
              <Link to="/quizCategory">
                ...
                >
                  <span className="relative z-10 flex items-center gap-2">
                    Explore Quizzes <Rocket size={18} className="group-hover:translate-x-1 transition-transform" />
                  </span>
                  <motion.div
              ...
              >
                <span className="w-10 h-10 rounded-full bg-gradient-to-br from-amber-500/20 to-orange-500/20 flex items-center justify-center">
                  <Trophy size={16} className="ml-0.5" fill={T.gold} color={T.gold} />
                </span>
                View Leaderboard
              </motion.button>
            </motion.div>
          ...
          >
            ...
            >
              <div className="relative">
                  ...
                  <div className="relative p-6">
                    ...
                    <div className="relative">
                      ...
                      <div className="grid grid-cols-3 gap-3 mb-6">
                        {[
                          { icon: Target, label: "Questions", value: "20" },
                          { icon: Clock, label: "Duration", value: "15m" },
                      ...
                      <div className="mb-6">
                        <div className="flex justify-between text-sm mb-2" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                          <span style={{ color: T.ivoryMuted }}>Completed</span>
                          <span style={{ color: T.gold, fontWeight: 600 }}>2.5k+ attempts</span>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm" style={{ color: T.ivoryMuted }}>+2.5k completed</span>
                        </div>
                        <Link to="/quizCategory">
                          <motion.button
                            whileHover={{ scale: 1.05 }}
                ...
                >
                  <div className="flex items-center gap-2">
                    <Award size={24} color={T.obsidian} />
                    <div>
                      <div className="font-bold text-lg" style={{ color: T.obsidian, fontFamily: "'Playfair Display', serif" }}>Top 5%</div>
                      <div className="text-xs font-semibold" style={{ color: T.obsidian, opacity: 0.8 }}>Earn Certificate</div>
                    </div>
                  </div>
                </motion.div>
