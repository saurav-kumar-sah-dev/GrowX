        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              Manage Tasks <span className="bg-gradient-to-r from-[#D4A853] to-[#E8C17A] bg-clip-text text-transparent">Efficiently</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <button 
                ...
                className="bg-gradient-to-r from-[#D4A853] to-[#C8884A] text-[#0A0A0F] px-8 py-4 rounded-full font-semibold hover:from-[#C8884A] hover:to-[#D4A853] transition-all shadow-lg shadow-[#D4A853]/25 flex items-center gap-2"
              >
                <CheckSquare size={20} />
                Get Started
              </button>
              <button 
                ...
                className="border-2 border-[#D4A853] text-[#D4A853] px-8 py-4 rounded-full font-semibold hover:bg-[#D4A853] hover:text-[#0A0A0F] transition-all flex items-center gap-2"
              >
                <Play size={20} />
                Watch Demo
              </button>
            ...
            <div className="flex gap-8 mt-10">
              <div>
                ...
                <div className="text-[#A8A099]">Tasks Managed</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-[#C8884A]">Real-time</div>
                <div className="text-[#A8A099]">Updates</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-[#E8C17A]">Easy</div>
                <div className="text-[#A8A099]">Drag & Drop</div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="relative">
            <div className="relative bg-[#121218]/80 backdrop-blur-lg rounded-3xl p-8 border border-[#252532]">
              ...
              <img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&h=400&fit=crop" alt="Kanban Board" className="rounded-2xl shadow-2xl border border-[#252532]" />
              <div className="mt-6 flex items-center gap-4">
                ...
                <div className="text-sm">
                  <div className="font-semibold text-[#F5F0E6]">Join productive teams</div>
                  <div className="text-[#A8A099]">Start organizing today</div>
                </div>
              </div>
            </div>
          </motion.div>
