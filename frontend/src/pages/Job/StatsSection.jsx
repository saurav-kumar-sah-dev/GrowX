...
import { Briefcase, Building2, TrendingUp, Star, CheckCircle, Zap, Shield, MapPin } from 'lucide-react';
...
export default function StatsSection() {
  ...
  const stats = [
    ...
    { icon: TrendingUp, value: "10K+", label: "Applications" },
      ...
      <div className="max-w-7xl mx-auto relative z-10" ref={containerRef}>
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif", color: C.ivory }}>
            Numbers That <span style={{ color: C.gold }}>Matter</span>
          </h2>

          <p className="text-base md:text-lg max-w-2xl mx-auto" style={{ color: C.ivoryMuted, fontFamily: "'DM Sans', sans-serif" }}>
            Join thousands of professionals who found their dream jobs through GrowX
          </p>
        </motion.div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <HighlightCard icon={CheckCircle} title="Verified Quality" description="All jobs reviewed by our team" />
          <HighlightCard icon={Zap} title="Fast Response" description="Get responses within 48 hours" />
          <HighlightCard icon={Shield} title="Secure Platform" description="Your data is protected" />
        </div>
        ...
        >
          ...
          >
            ...
            <span className="text-base" style={{ color: C.ivoryMuted }}>from job seekers</span>
          </div>
        </motion.div>
      </div>
    </section>
