...
import { Briefcase, ArrowRight, Sparkles, Users, Building2, TrendingUp, MapPin, Clock, Search } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight" style={{ fontFamily: "'Playfair Display', serif", color: C.ivory }}>
              Find Your <span style={{ color: C.gold }}>Dream Job</span> Today
            </h1>

            <p className="text-lg md:text-xl mb-8" style={{ color: C.ivoryMuted, fontFamily: "'DM Sans', sans-serif" }}>
              Discover opportunities from top companies. Connect with recruiters, apply instantly, and accelerate your career journey.
            </p>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div>
                  <div className="font-semibold" style={{ color: C.ivory }}>10K+ Professionals</div>
                  <div className="text-sm" style={{ color: C.ivoryMuted }}>Found their dream job</div>
                </div>
              </motion.div>
            </motion.div>
