...
import { Target, Building2, Award, Zap, Briefcase, TrendingUp, CheckCircle, Users } from 'lucide-react';
...
const features = [
  { icon: Target, title: 'Smart Matching', desc: 'AI-powered job matching to find your perfect role' },
  { icon: Building2, title: 'Top Companies', desc: 'Access opportunities from 100+ verified companies' },
  { icon: Award, title: 'Verified Jobs', desc: 'All listings verified for authenticity and legitimacy' },
  { icon: Zap, title: 'Quick Apply', desc: 'Apply to multiple jobs with one-click submission' },
  { icon: Briefcase, title: 'Career Growth', desc: 'Resources to accelerate your professional journey' },
  { icon: TrendingUp, title: 'Market Insights', desc: 'Real-time salary data and industry trends' },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6" style={{ fontFamily: "'Playfair Display', serif", color: C.ivory }}>
              Your Gateway to <span style={{ color: C.gold }}>Career Success</span>
            </h2>

            <p className="text-base md:text-lg mb-8 leading-relaxed" style={{ color: C.ivoryMuted, fontFamily: "'DM Sans', sans-serif" }}>
              GrowX Job Portal connects talented professionals with leading companies. Our platform offers verified job listings, 
              instant applications, and personalized job recommendations to help you land your dream role.
            </p>
          ...
          >
            <div className="relative">
              ...
              >
                <div className="text-3xl font-bold" style={{ fontFamily: "'Playfair Display', serif", color: C.obsidian }}>10K+</div>
                <div className="text-sm font-medium" style={{ color: C.obsidian }}>Jobs Filled</div>
              </motion.div>
              ...
              >
                <div className="text-2xl font-bold mb-1" style={{ fontFamily: "'Playfair Display', serif", color: C.gold }}>100%</div>
                <div className="text-sm font-medium" style={{ color: C.ivoryMuted }}>Verified Listings</div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium" style={{ color: C.ivory }}>Trusted</span>
                </div>
              </motion.div>
            </div>
