...
import { Target, Users, Award, Zap, BookOpen, CheckCircle, TrendingUp, Award as CertIcon } from 'lucide-react';
...
const features = [
  ...
  { icon: CertIcon, title: 'Certified Learning', desc: 'Earn recognized certificates upon course completion' },
  { icon: Zap, title: 'Fast-Track Skills', desc: 'Accelerated programs to quickly master in-demand skills' },
  { icon: BookOpen, title: 'Rich Content', desc: 'Comprehensive courses with hands-on projects' },
  { icon: TrendingUp, title: 'Career Growth', desc: 'Skills that matter for your professional development' },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6" style={{ fontFamily: "'Playfair Display', serif", color: C.ivory }}>
              Transform Your Career with <span style={{ color: C.gold }}>Expert-Led Learning</span>
            </h2>
          ...
          >
            <div className="relative">
              ...
              >
                <div className="text-3xl font-bold" style={{ fontFamily: "'Playfair Display', serif", color: C.obsidian }}>10M+</div>
                <div className="text-sm font-medium" style={{ color: C.obsidian }}>Hours of Learning</div>
              </motion.div>
              ...
              >
                <div className="text-2xl font-bold mb-1" style={{ fontFamily: "'Playfair Display', serif", color: C.gold }}>4.9★</div>
                <div className="text-sm font-medium" style={{ color: C.ivoryMuted }}>Average Rating</div>
              </motion.div>
